...
if __name__ == '__main__':
    ...
    byte_index = AES.block_size - 1#numbers start from 0
    c_15 = block_to_modify[byte_index]#last byte
    ...
    p_prime_15 = 81#not correct using 83 it is a false positive
    print("--------------")
    ...
    byte_index -= 1
    c_14 = block_to_modify[byte_index]  # last byte
...
"""
   look at: https://github.com/AonCyberLabs/PadBuster
"""
